...
int main()
{
    ...
    clilstnaddr.sin_port = htons(SERV_PORT1);
    inet_pton(AF_INET, SERV_IP1, &clilstnaddr.sin_addr);
    ...
    wkrlstnaddr.sin_port = htons(PROXY_PORT1);
    inet_pton(AF_INET, PROXY_IP1, &wkrlstnaddr.sin_addr);
